                  ...
                  <aside class="aside-lg bg-light lter b-r">
                    <div class="wrapper">
                      ...
                      <form method="POST">
                        ...
                        <div class="form-group">
                          <label>Note</label>
                          <textarea name="note" class="form-control" rows="8" data-minwords="8" data-required="true" placeholder="...."></textarea>
                        </div>
                        <div class="m-t-lg"><button class="btn btn-sm btn-default" name="submit" type="submit">Save</button></div>
                      </form>
                    </div>
                </aside>
                  ...
                  <section class="vbox">
                    <header class="header bg-light bg-gradient">
                      <ul class="nav nav-tabs nav-white">
                        <li class="active"><a href="#activity" data-toggle="tab"><h4 style = "text-transform:uppercase;"><b>Saved Notes</b></h4></a></li>
                      </ul>
                    </header>
                        ...
                        <section class="panel clearfix bg-info lter">
                          <div class="panel-body">
                            <a href="#" class="thumb pull-left m-r">
                              <img src="https://i.pinimg.com/280x280_RS/8f/91/04/8f91048e11c461bb9657e5b68752cdfc.jpg" class="img-circle">
                            </a>
                            <div class="clear">
                              <a href="#" class="text-info">Chemistry </a>
                            </div>
                          </div>
                        </section>
                        <section class="panel clearfix bg-info lter">
                          <div class="panel-body">
                            <a href="#" class="thumb pull-left m-r">
                              <img src="https://us.123rf.com/450wm/olehsvetiukha/olehsvetiukha1803/olehsvetiukha180300527/97055005-a-vector-shining-neon-lights-atom-model-.jpg?ver=6" class="img-circle">
                            </a>
                            <div class="clear">
                              <a href="#" class="text-info">Physics </a>
                            </div>
                          </div>
                        </section>
                        <section class="panel clearfix bg-info lter">
                          <div class="panel-body">
                            <a href="#" class="thumb pull-left m-r">
                              <img src="images/math.jpg" class="img-circle">
                            </a>
                            <div class="clear">
                              <a href="#" class="text-info">Maths </a>
                            </div>
                          </div>
                        </section>
                      </div>
